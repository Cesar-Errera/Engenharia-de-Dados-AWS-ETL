...
SNS_TOPIC_ARN = 'arn:aws:sns:us-east-1:091770677918:snsalerta'
...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        print(f"DEBUG - Conteudo recebido: {data}") # Adicione essa linha aqui
        ...
        try:
            ...
            print(f"Erro ao mapear o JSON: {e}")
            continue # Pula para o próximo registro se este estiver estranho
